...
#############  Animals #######
animals_params = %{sex: "M", chip_number: "dsfdsfs2", address: "Kolio Ficheto 24",  animals_status_id: 1}
...
############# News #####################
news_params = %{image_url: "C://image.jpg", title: "Изгъбено куче!", meta: "kuce, miss", keywords: "miss, lost", content: "Obatede se ako go namerite", short_content: "Help my", date: "2018-05-22 11:56:16"}
...
############## Signals #############
signals_params = %{address: "бул. Владислав Варненчик", chip_number: "2343565645", description: "Нападение", support_count: 0, title: "Внимавайте", view_count: 0, signals_categories_id: 1, signals_types_id: 1}
...
############## Signals Comments #############
signal_comment_params = %{comment: "Още е там никой не го е прибрал??", users_id: 1, signals_id: 1}
