defmodule SmartCityDogsWeb.SignalsCommentControllerTest do
  ...
  describe "update signals_comment" do
    ...
    test "renders signals_comment when data is valid", %{
      conn: conn,
      signals_comment: %SignalsComment{id: id} = signals_comment
    } do
      conn =
        put(
          conn,
          signals_comment_path(conn, :update, signals_comment),
          signals_comment: @update_attrs
        )
