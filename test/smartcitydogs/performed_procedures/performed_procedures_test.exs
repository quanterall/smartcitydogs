defmodule SmartCityDogs.PerformedProceduresTest do
  ...
  describe "performed_procedure" do
    ...
    test "get_performed_procedure!/1 returns the performed_procedure with given id" do
      ...
      assert PerformedProcedures.get_performed_procedure!(performed_procedure.id) ==
               performed_procedure
    end

    test "create_performed_procedure/1 with valid data creates a performed_procedure" do
      assert {:ok, %PerformedProcedure{} = performed_procedure} =
               PerformedProcedures.create_performed_procedure(@valid_attrs)
    ...
    test "create_performed_procedure/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               PerformedProcedures.create_performed_procedure(@invalid_attrs)
    end

    test "update_performed_procedure/2 with valid data updates the performed_procedure" do
      performed_procedure = performed_procedure_fixture()

      assert {:ok, performed_procedure} =
               PerformedProcedures.update_performed_procedure(performed_procedure, @update_attrs)
    ...
    test "update_performed_procedure/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               PerformedProcedures.update_performed_procedure(performed_procedure, @invalid_attrs)

      assert performed_procedure ==
               PerformedProcedures.get_performed_procedure!(performed_procedure.id)
    end

    test "delete_performed_procedure/1 deletes the performed_procedure" do
      performed_procedure = performed_procedure_fixture()

      assert {:ok, %PerformedProcedure{}} =
               PerformedProcedures.delete_performed_procedure(performed_procedure)
    ...
    test "change_performed_procedure/1 returns a performed_procedure changeset" do
      ...
      assert %Ecto.Changeset{} =
               PerformedProcedures.change_performed_procedure(performed_procedure)
    end
  end
end
