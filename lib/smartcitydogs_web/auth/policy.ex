defmodule Smartcitydogs.Policy do
@behaviour Bodyguard.Policy
  ...
  def authorize(_, %User{users_types_id: 3}, _), do: true

    # Municipality users can do anything
  def authorize(_, %User{users_types_id: 4}, _), do: true
...
# Bodyguard.permit(Smartcitydogs.Animals.Policy, :new, user) - проверка за достъп (модул, функция, потребител)