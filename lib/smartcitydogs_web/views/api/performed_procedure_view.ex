defmodule SmartcitydogsWeb.PerformedProcedureControllerAPIView do
  ...
  def render("index.json", %{performed_procedure: performed_procedure}) do
    %{data: render_many(performed_procedure, PerformedProcedureControllerAPIView, "performed_procedure.json")}
  end

  def render("show.json", %{performed_procedure: performed_procedure}) do
    %{data: render_one(performed_procedure, PerformedProcedureControllerAPIView, "performed_procedure.json")}
  end

  def render("performed_procedure.json", %{performed_procedure_controller_api: performed_procedure}) do
    %{
